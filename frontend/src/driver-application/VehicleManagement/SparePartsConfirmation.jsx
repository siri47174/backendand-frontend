...
//       <h2>Confirm Spare Parts Details</h2>
//       <form>
...
// export default SparePartsConfirmation;
import React from "react";
import { useLocation, useNavigate } from "react-router-dom";
...
const SparePartsConfirmation = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      alert("Spare parts submitted successfully!");
  ...
  return (
    <div style={styles.container}>
      <div style={styles.pageHeader}>SPARE PARTS CONFIRMATION</div>

      <div style={styles.formWrapper}>
        <div style={styles.sectionTitle}>Review Spare Parts Details</div>
        ...
        {Object.entries(formData).length > 0 ? (
          ...
          <p style={{ color: "#aaa", fontSize: "14px", padding: "20px 0" }}>
            No data found. Please navigate from the spare parts form.
          </p>
        )}
